    ...
    <div className="pt-24">
      ...
      <section className="bg-[#D4ECEE] py-24 border-b border-brand-primary/20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-7xl font-display font-bold text-brand-dark mb-6">Our Services</h1>
          <p className="text-gray-700 font-medium text-xl max-w-2xl mx-auto leading-relaxed">
            From routine checkups to full smile transformations, we provide comprehensive dental care for patients of all ages.
          </p>
        </div>
      </section>
